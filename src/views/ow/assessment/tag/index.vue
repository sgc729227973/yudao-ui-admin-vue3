<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <!-- 操作按钮 -->
      <el-form-item>
        <el-button @click="handleQuery" v-hasPermi="['ow:assessment:tag:query']">
        ...
        <el-button
          ...
          v-hasPermi="['ow:assessment:tag:create']"
        >
      ...
      <el-table-column align="center" label="操作">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['ow:assessment:tag:update']"
          >
            修改
          </el-button>
          <el-button
            ...
            v-hasPermi="['ow:assessment:tag:delete']"
          >
            删除
          </el-button>
        </template>
...
import * as TagApi from '@/api/ow/assessment/tag'
