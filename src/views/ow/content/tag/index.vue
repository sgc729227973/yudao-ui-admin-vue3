<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        v-hasPermi="['ow:content:tag:query']"	
        >
        ...
        <el-button 
          ...
          v-hasPermi="['ow:content:tag:create']"	
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" stripe>
      ...
      <el-table-column align="center" label="载体类型" prop="carrierType">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.MP_MESSAGE_TYPE" :value="scope.row.carrierType" />
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作">
        <template #default="scope">
          <el-button 
            ...
            v-hasPermi="['ow:content:tag:update']"	
          >
            修改
          </el-button>
          <el-button 
            ...
            v-hasPermi="['ow:content:tag:delete']"	
          >
            删除
          </el-button>
        </template>
...
import * as TagApi from '@/api/ow/content/tag'
