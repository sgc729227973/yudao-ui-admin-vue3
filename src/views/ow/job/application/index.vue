<template>
  <ContentWrap>
    ...
    >
      ...
      <!-- 申请人姓名 -->
      <el-form-item label="申请人" prop="firstName">
        <el-input v-model="queryParams.firstName" placeholder="请输入申请人名字" clearable class="!w-240px" />
      </el-form-item>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="申请人姓名" align="center" prop="fullName">
...
import { getJobApplicationList, exportJobApplication, JobApplicationVO } from '@/api/ow/job/application'
