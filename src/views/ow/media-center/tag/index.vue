    ...
    >
      ...
      <el-form-item>
        ...
        <el-button 
          ...
          v-hasPermi="['ow:media-tag:create']"	
        >
      ...
      <el-table-column align="center" label="操作">
        <template #default="scope">
          <el-button 
            ...
            v-hasPermi="['ow:media-tag:update']"	
          >
            修改
          </el-button>
          <el-button 
            ...
            v-hasPermi="['ow:media-tag:delete']"	
          >
            删除
          </el-button>
        </template>
...
import * as TagApi from '@/api/ow/media-center/tag'
