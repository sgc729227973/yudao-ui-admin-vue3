  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        v-hasPermi="['ow:release-tag:query']"	
        >
        ...
        <el-button 
          ...
          v-hasPermi="['ow:release-tag:create']"	
        >
      ...
      <el-table-column align="center" label="操作">
        <template #default="scope">
          <el-button 
            ...
            v-hasPermi="['ow:release-tag:update']"	
          >
            修改
          </el-button>
          <el-button 
            ...
            v-hasPermi="['ow:release-tag:delete']"	
          >
            删除
          </el-button>
        </template>
...
import * as TagApi from '@/api/ow/release-center/release-tag'
